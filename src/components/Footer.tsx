...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full border-t border-white/10 bg-black py-12 px-4 sm:px-6 lg:px-8 text-xs text-zinc-400">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
        ...
        <div className="flex flex-col items-center md:items-start gap-2">
          ...
          <p className="text-zinc-500 text-xs font-light max-w-sm">
            Personalized movie recommendations engineered with Exa Neural Search and GPT-4o multi-step reasoning.
          </p>
        </div>
